...
We'll start by learning how to deploy an ERC-721 smart contract on a rollup
with a verifiable random function (VRF). Then we'll learn how to mint
an ERC-1155 on the rollup by using our ERC-721 as a prerequisite for minting.

Get started with [Module 1](/modules/1/introduction-to-module-1). This will show you how to
create an ERC-721 smart contract on Bubs testnet
with a VRF.

<Button href="/modules/1/introduction-to-module-1">Module 1</Button>
